...
class TestThomas2DRotalittle(gym.Env):
    metadata = {
	...
	self.vit = 1
	self.rota_speed = 1
        self.treeslocations = [3.0, 5.0, 4.0, 6.0];
        self.battery_zone = [2.0, 7.0];
        self.water_zone = [7.0,1.0];
        self.fuites_view = [325, 375, 325, 375, 325, 375, 325, 375, 125,125,175,175,225,225,275,275];
